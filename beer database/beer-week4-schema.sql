--
-- Name: nbeers; Type: VIEW; Schema: public; Owner: -
--

CREATE VIEW public.nbeers AS
 SELECT beers.brewer,
    count(*) AS count
   FROM public.beers
...
--
-- Name: newpriceatcbh; Type: VIEW; Schema: public; Owner: -
--

CREATE VIEW public.newpriceatcbh AS
 SELECT sells.price
   FROM public.sells
  WHERE (((sells.bar)::text = 'Coogee Bay Hotel'::text) AND ((sells.beer)::text = 'Victoria Bitter'::text));


--
-- Name: vbprice; Type: VIEW; Schema: public; Owner: -
--

CREATE VIEW public.vbprice AS
 SELECT newpriceatcbh.price
   FROM public.newpriceatcbh;
...
Peanut Butter Pastry Stout	Hop Nation	Stout
...
Fudge Dredd	Dainton	Porter
Conductor's Special Porter	Quiet Deeds	Smoky Porter
\.
